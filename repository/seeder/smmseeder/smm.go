...
func SeedSMMData(ctx context.Context, db *postgres.DB) error {
	...
	rawServices := []struct {
		...
		// Instagram Services
		{20010000890098, "Instagram Likes - Real", "Default", "0.80", 50, 100000, false, true, true, "instagram_likes", "justanotherpanel"},
		{20020000890098, "Instagram Likes - High Quality", "Default", "1.20", 100, 50000, false, true, true, "instagram_likes", "justanotherpanel"},
		{20030000890098, "Instagram Followers - Real", "Default", "8.50", 100, 50000, false, true, true, "instagram_followers", "justanotherpanel"},
		{20040000890098, "Instagram Post Views", "Default", "0.10", 100, 1000000, false, false, true, "instagram_views", "justanotherpanel"},
	...
	mappings := []struct {
		...
		// Telegram - Views
		{1, "1K Post Views", "telegram", "views", "1000 بازدید پست تلگرام", "👁️ 1K بازدید", 1, true},
		{2, "5K Post Views", "telegram", "views", "5000 بازدید پست تلگرام", "️ 5K بازدید", 2, true},
		{3, "Story Views", "telegram", "views", "بازدید استوری تلگرام", "️ بازدید استوری", 3, true},

		// Telegram - Reactions
		{4, "Positive Reaction", "telegram", "reactions", "ری‌اکشن مثبت (👍❤️🔥)", "❤️ ری‌اکشن مثبت", 1, true},

		// Telegram - Members
		{5, "Real Members", "telegram", "members", "ممبر واقعی تلگرام", "👥 ممبر واقعی", 1, true},
		{6, "Premium Members", "telegram", "members", "ممبر پرمیوم تلگرام", "💎 ممبر پرمیوم", 2, true},
		{7, "Fake Members", "telegram", "members", "ممبر فیک ارزان", "👤 ممبر فیک", 3, true},

		// Telegram - Shares
		{8, "Post Shares", "telegram", "shares", "فوروارد/شیر پست تلگرام", "🔄 فوروارد پست", 1, true},

		// Instagram - Likes
		{9, "Real Likes", "instagram", "likes", "لایک واقعی اینستاگرام", "❤️ لایک واقعی", 1, true},
		{10, "HQ Likes", "instagram", "likes", "لایک با کیفیت بالا", "💎 لایک HQ", 2, true},

		// Instagram - Followers
		{11, "Real Followers", "instagram", "followers", "فالوور واقعی اینستاگرام", "👤 فالوور واقعی", 1, true},

		// Instagram - Views
		{12, "Post Views", "instagram", "views", "بازدید پست اینستاگرام", "👁️ بازدید پست", 1, true},

		// TikTok
		{13, "TikTok Views", "tiktok", "views", "بازدید تیک‌تاک", "👁️ بازدید", 1, true},
		{14, "TikTok Likes", "tiktok", "likes", "لایک تیک‌تاک", "❤️ لایک", 2, true},
		{15, "TikTok Followers", "tiktok", "followers", "فالوور تیک‌تاک", "👤 فالوور", 3, true},

		// WhatsApp
		{16, "Group Members", "whatsapp", "members", "ممبر گروه واتس‌اپ", "👥 ممبر گروه", 1, true},

		// Twitter/X
		{17, "Twitter Followers", "twitter", "followers", "فالوور توییتر", "👤 فالوور", 1, true},
		{18, "Twitter Likes", "twitter", "likes", "لایک توییتر", "❤️ لایک", 2, true},
	}
