...
func (db *DB) SMMMappingCreate(ctx context.Context, m *smmentity.SmmMapping) error {
	...
	query := `INSERT INTO smm_service_mapping (smm_service_id, name, platform, category, description, is_active)
	          VALUES ($1, $2, $3, $4, $5, $6) RETURNING id, created_at, updated_at`
	if err := db.Pool.Connection().QueryRow(ctx, query,
		m.SmmServiceId, m.Name, m.Platform, m.Category, m.Description, m.IsActive,
