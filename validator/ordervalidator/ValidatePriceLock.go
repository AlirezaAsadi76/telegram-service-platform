...
func (v *Validator) ValidatePaymentPriceLock(req checkoutparams.WalletPurchaseRequest, method entity.PriceLockPaymentMethod) error {

	const op = "checkout.ValidatePaymentPriceLock"
...
func (v *Validator) ValidateDirectPaymentPriceLock(req checkoutparams.DirectPaymentPurchase, method entity.PriceLockPaymentMethod) error {

	const op = "checkout.ValidateDirectPaymentPriceLock"
